        ...
        <section class="domain-search--section pt--70 pb--70"  >
            <div class="container">
             <div class="section--title pb--30 text-center">
                    <h2 class="h1 text-uppercase"><strong>Search Your Nearby places Here</strong></h2>
                    <div class="row">
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        ?>
                            <div class="service--item style--1 p--80 bg--c-main text-center ">
                                ...
                                <div class="title text-uppercase">
                                    <h2 class="h4"><?php echo $area_name; ?></h2> </div>
                                <div class="desc">
                                    <p>
                       ...
                       while ($row = mysqli_fetch_array($result)) {
                            ...
                            <div class="col-md-6 col-xs-6  pb--30">
                                <div class="feature--item style--1 text-center">
                                    ...
                                    <div class="title">
                                        <h3 class="h4"><?php echo strtoupper($vehicle_name); ?></h3> </div>
                                    <div class="desc">
