<?php 
	...
	if(isset($_POST['area_id'])){
		...
		$sql = "SELECT vtc.vehicle_type_check_id,vtc.vehicle_type_id,vtc.area_id,vt.vehicle_id,vt.vehicle_name FROM vehicle_type_check vtc LEFT JOIN vehicletype vt ON vtc.vehicle_type_id = vt.vehicle_id WHERE vtc.area_id=$area_id";
