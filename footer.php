<footer class="footer--section" data-bg-img="img/footer-img/footer-widget-bg.jpg">
                    ...
                    <div class="row AdjustRow">
                        <div class="col-md-3 col-xs-6 col-xss-12 pb--60">
                            <div class="widget">
                                <div class="about--widget">
                                    <div class="logo"> <img src="img/logo.png" alt=""> </div><address> <p>52 Shewrapara, Ibrahimpur, Mirpur 2653, Dhaka.</p></address>
                                    <dl> <dt><i class="fa fa-envelope-o"></i>Email</dt>
                                        <dd>
                                            <p> <span>Sales:</span> <a href="http://themelooks.us/cdn-cgi/l/email-protection#4734262b223407223f262a372b226924282a" class="btn-link"><span class="__cf_email__" data-cfemail="1e6d7f727b6d5e7b667f736e727b307d7173">[email&#160;protected]</span></a> </p>
                                            <p> <span>Support:</span> <a href="http://themelooks.us/cdn-cgi/l/email-protection#364543464659444276534e575b465a531855595b" class="btn-link"><span class="__cf_email__" data-cfemail="483b3d3838273a3c082d30292538242d662b2725">[email&#160;protected]</span></a> </p>
                                        </dd>
                                    </dl>
                                    <dl> <dt><i class="fa fa-phone"></i>Phone</dt>
                                        <dd>
                                            <p> <span>Sales:</span> <a href="tel:00123412345" class="btn-link">001 234 12345</a> </p>
                                            <p> <span>Support:</span> <a href="tel:00123412345" class="btn-link">001 234 12345</a> </p>
                                        </dd>
                                    </dl>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 col-xs-6 col-xss-12 pb--60">
                            ...
                            <div class="widget">
                                ...
                                <div class="img---widget"> <img src="img/footer-img/payment-methods.png" alt=""> </div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="title">
                        <h2 class="h4">Login</h2> </div>
                    <form action="http://billing.ywhmcs.com/dologin.php" data-form="validate">
                        <div class="form-group">
                            <input type="email" name="username" placeholder="Your Email" class="form-control" required> </div>
                        <div class="form-group">
   ...
   <script data-cfasync="false" src="js/jquery-3.3.1.min.js"></script>
...
<!-- Mirrored from themelooks.us/demo/cloudsky/html/preview/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 18 Jan 2019 02:58:28 GMT -->
